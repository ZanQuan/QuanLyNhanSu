    ...
    public partial class frmDoiMatKhau : Form
    {
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            int count = Convert.ToInt32(DataProvider.ExecuteScalar(
                ...
                new[] {
                    new SqlParameter("@TenDN", SessionInfo.TenDangNhap),
                    new SqlParameter("@MKCu", DataProvider.HashPassword(mkCu))
                }));
            ...
            if (DataProvider.ExecuteNonQuery(
                ...
                new[] {
                    new SqlParameter("@MKMoi", DataProvider.HashPassword(mkMoi)),
                    new SqlParameter("@TenDN", SessionInfo.TenDangNhap)
                }) > 0)
            {
